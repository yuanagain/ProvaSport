      ...
      <div className="col-sm-6 col-sm-offset-3">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input className="form-control" ref={(fName) => this.fName = fName} placeholder="First Name"/>
          </div>

          <div className="form-group">
            <label>Last Name</label>
            <input className="form-control" ref={(lName) => this.lName = lName} placeholder="Last Name"/>
          </div>
          ...
          <div className="form-group">
          <select id="birthday_month" ref={(month) => this.month = month}>
          ...
          <div className="form-group">
          <select id="birthday_day" ref={(day) => this.day = day}>
          ...
          <div className="form-group">
          <select id="birthday_year" ref={(year) => this.year = year}>
          <option disabled value>Day</option>
